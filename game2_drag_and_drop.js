...
const dragAndDropPuzzlesData2 = [
    ...
    { correctWord: "Uncle", image: "./Pictures/дядько.jpg", draggableWord: "Uncle" },
    { correctWord: "Ten", image: "./Pictures/10.jpg", draggableWord: "Ten" },
    { correctWord: "Pink", image: "./Pictures/рожевий.jpg", draggableWord: "Pink" },
    { correctWord: "Sister", image: "./Pictures/сестра.jpg", draggableWord: "Sister" },
    { correctWord: "Five", image: "./Pictures/5.jpg", draggableWord: "Five" },
    { correctWord: "Aunt", image: "./Pictures/тітка.jpg", draggableWord: "Aunt" },
    ...
    { correctWord: "Grandfather", image: "./Pictures/дідусь.jpg", draggableWord: "Grandather" },
...
class DragAndDropImageGame {
    ...
    createPuzzle(puzzleData, index) {
        ...
        puzzleWrapper.innerHTML = `
            ...
            <div class="word-drop-zone w-full h-14 flex justify-center items-center border-2 border-dashed border-gray-300 rounded-md text-lg font-bold text-gray-500 overflow-hidden">
