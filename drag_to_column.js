...
const columnDragDropGameData1 = {
  columns: [
    { id: "Family", title: "Сім'я", correctWords: ["Aunt", "Grandmother", "Grandfather", "Uncle"] },
    { id: "Colours", title: "Кольори", correctWords: ["Purple", "Black", "White", "Green"] },
    { id: "Numbers", title: "Цифри", correctWords: ["Eight", "Three", "Nine", "Zero"] },
    { id: "Greetings", title: "Вітання", correctWords: ["Good morning", "Good afternoon", "Good evening", "Good night"] }
  ],
  allDraggableWords: [
    "Aunt", "Grandmother", "Grandfather", "Uncle",
...
const columnDragDropGameData2 = {
  columns: [
    { id: "A", title: "A", correctWords: ["cucumber", "pepper", "carrot", "horse", "strawberry", "raspberry"] },
    { id: "AN", title: "AN", correctWords: ["onion", "orange", "apple", "elephant", "uncle", "aunt"] }
  ],
  allDraggableWords: [
    "cucumber", "onion", "orange", "apple", "carrot", "horse", "strawberry", "raspberry", "elephant", "uncle", "aunt"  
  ]
};
