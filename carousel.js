...
const carouselImages = [
    { src: "./Pictures/1.1.jpg", alt: "greetings" },
    { src: "./Pictures/2.1.jpg", alt: "How are you" },
    { src: "./Pictures/3.1.jpg", alt: "Nice to meet you" },
    { src: "./Pictures/4.1.jpg", alt: "Numbers" },
    { src: "./Pictures/5.1.jpg", alt: "Colours" },
    { src: "./Pictures/6.1.jpg", alt: "Family" },
    { src: "./Pictures/7.1.jpg", alt: "Personal pronouns" }
];

// Зображення для каруселі 2

const carouselImages2 = [
    { src: "./Pictures/articles.jpg", alt: "Lion" },
    { src: "./Pictures/example.jpg", alt: "Bear" },
